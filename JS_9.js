...
$('.ans_btn').click(function() {
	if(first_section == 4){
		jQuery("#nineteenth").show();
		 ...
		 jQuery('.btn_icon').html('<span><img src="icon/check.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Correct <span class="tooltip_img"><img src="icon/check.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Insert text here</p></span>');
		
		 
	} else{
		jQuery(".final").hide();jQuery("#nineteenth").hide();
		jQuery(this).css('border', '2px solid red');
		jQuery('.btn_icon').html('<span><img src="icon/remove.svg" class="icon_img"/></span> <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="icon/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Insert text here</p></span>');
	...
	if (answer.value == "a1") {
		jQuery("#Assumptions1").css( 'border', 'solid green');
		 jQuery('#ninth').html('<span><img src="icon/check.svg" class="icon_img"/></span> <span class="tooltip__content"><p class="tooltip_header">Correct <span class="tooltip_img"><img src="icon/check.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Insert text here</p></span>');
    jQuery('#ninth').css('font-size', '8px');
	}else{
		jQuery("#Assumptions1").css( 'border', 'solid red');
		jQuery('#ninth').html('<span><img src="icon/remove.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="icon/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Insert text here</p></span>');
		jQuery('#ninth').css('font-size', '8px');
	}
	...
	if (answer.value == "b2") {
		...
		jQuery('#tenth').html('<span><img src="icon/check.svg" class="icon_img"/></span> <span class="tooltip__content"><p class="tooltip_header">Correct <span class="tooltip_img"><img src="icon/check.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Insert text here</p></span>');
		jQuery('#tenth').css('font-size', '8px');
	}else{
		jQuery("#Assumptions2").css( 'border', 'solid red');
		jQuery('#tenth').html('<span><img src="icon/remove.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="icon/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Insert text here</p></span>');
		jQuery('#tenth').css('font-size', '8px');
	}
	...
	if (answer.value == "c2") {
		...
		jQuery('#eleventh').html('<span><img src="icon/remove.svg" class="icon_img"/></span> <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="icon/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Insert text here</p></span>');
	...
	if (answer.value == "d2") {
		...
		jQuery('#twelfth').html('<span><img src="icon/check.svg" class="icon_img"/></span> <span class="tooltip__content"><p class="tooltip_header">Correct <span class="tooltip_img"><img src="icon/check.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Insert text here</p></span>');
		jQuery('#twelfth').css('font-size', '8px');
	}else{
		jQuery("#Assumptions4").css( 'border', 'solid red');
		jQuery('#twelfth').html('<span><img src="icon/remove.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="icon/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Insert text here</p></span>');
		jQuery('#twelfth').css('font-size', '8px');
	}
	 $('.tooltip').show();
